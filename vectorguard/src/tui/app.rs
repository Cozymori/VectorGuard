...
fn build_config_fields(text: &str) -> Vec<ConfigField> {
    let mut fields = vec![
        ...
        ConfigField { section: "ai_advisor", label: "api_key",              toml_key: "api_key",              description: "OpenAI API key (sk-...)",          field_type: FieldType::Str,   value: String::new() },
        ConfigField { section: "ai_advisor", label: "model",                toml_key: "model",                description: "gpt-4o / gpt-4o-mini",             field_type: FieldType::Str,   value: String::new() },
